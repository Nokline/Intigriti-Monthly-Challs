...
- Interestingly enough, this simple JSONP endpoint seemed to work too: [`https://www.googleapis.com/customsearch/v1?callback=alert(document.domain)`](https://www.googleapis.com/customsearch/v1?callback=alert(document.domain)//), I still find it pretty weird how google allows this lol
