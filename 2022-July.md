...
- When we send this payload, we see that the values we passed in the columns are reflected in the response, but they are HTML encoded </br><img src=/Screen%20Shot%202022-07-29%20at%209.35.57%20AM.png height=50% width=50% name=BRUH/>
